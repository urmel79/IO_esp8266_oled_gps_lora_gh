//
//    FILE: function_runningMedian_double.h
...
#ifndef function_runningMedian_double_hpp
...
public:
  ...
  double getHighest() { return getSortedElement(_cnt - 1); };
...
#endif  // function_runningMedian_double_hpp
// END OF FILE
